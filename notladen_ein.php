...
$bats_chg = ((int)substr($antw[0],5,4)/10); // Max. charging current
...
echo "**** Jetzt setzen wir NOTLADEN! ****\n";
//$check = cal_crc_half("^S005EDB1");
fwrite($fp, "^S005EDB1".chr(0x0d)); // ^P014EDyyyymmddnnn<cr>: Query generated $
$antw =  parse_antw();
...
fwrite($fp, "^S011MUCHGC0500".chr(0x0d)); //use 50A from grid to charge
$antw =  parse_antw();
...
fwrite($fp, "^S010MCHGC0500".chr(0x0d));//use 50A from grid to charge
$antw =  parse_antw();
